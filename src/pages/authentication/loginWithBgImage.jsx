                    ...
                    <TabContent activeTab={selected} className="content-login">
                      <TabPane  className="fade show" tabId={selected === "firebase" ? "firebase" : "jwt"}>
                        <Form className="theme-form">
                          <h4>{selected === "firebase" ? "Faça seu login" : "Sign In With Jwt"}</h4>
                          ...
                          <h6 className="text-muted mt-4 or">{"Ou entre com sua conta"}</h6>
                          ...
                          <p className="mt-4 mb-0">{"Ainda não tem uma conta?"}<a className="ml-2" href="#javascript">{CreateAccount}</a></p>
                        </Form>
                      </TabPane>
